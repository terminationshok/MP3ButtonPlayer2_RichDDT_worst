...
Bounce b_Play1  = Bounce();
Bounce b_Play2  = Bounce();
...
void setup() {
  ...
  pinMode(B_PLAY1, INPUT_PULLUP);
  pinMode(B_PLAY2, INPUT_PULLUP);
  ...
  b_Play1.attach(B_PLAY1);
  b_Play1.interval(BUTTON_DEBOUNCE_PERIOD);
  b_Play2.attach(B_PLAY2);
  b_Play2.interval(BUTTON_DEBOUNCE_PERIOD);
